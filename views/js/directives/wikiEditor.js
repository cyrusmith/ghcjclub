                    ...
                    switch (action) {
                        case 'getAttachForm':
                            ...
                            if (type == 'smile') {
                                ...
                                Notifications.error = 'Эта Функциональность пока не поддерживается';
                                $scope.$apply();
                                break;
                                ajaxRequest('files/getAttachForm', {
                                    ...
                                    onSuccess: function (response) {
                                        ...
                                        switch (type) {
                                            case 'file':
                                                title = 'Загрузка архивов <br/>(RAR,ZIP. Файл не более ' + response.size + ')';
                                                break;

                                            case 'sample':
                                                title = 'Загрузка звукового семпла <br/>(Mp3. Файл не более ' + response.size + ')';
                                                break;

                                            case 'image':
                                                title = 'Загрузка изображения <br/>(PNG,JPG,GIF. Файл не более ' + response.size + ')';
                                                break;
