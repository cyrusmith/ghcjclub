<?
class Release extends CRUD {
	protected $modelClassName = 'ReleaseModel';
	/**
	 * @var FilterForm
	 */
	protected $filter;
	function buildFilter(){
		 ...
		 */
		$filer = $this->getModelInstance()->sets($_REQUEST);
		/*
	...
	*/
	...
	function lists(){
		//$this->buildFilter();
		//$this->customize->fields = 'id,label_id,name,type,descr,publicdate,state,tracklist,options,tracksToReview,filesize,timelength';
